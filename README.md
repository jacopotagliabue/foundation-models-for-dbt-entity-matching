...
*IMPORTANT*: The original dbt + Snowflake project below is now *also* available in a local version with a smaller footprint, thanks to [marvin](https://www.askmarvin.ai/getting_started/installation/) and [dbt-duckdb](https://github.com/jwills/dbt-duckdb). Therefore:
